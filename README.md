# stock-signals v2.8.5 — 多市场股票技术分析 & 买卖信号生成器

基于富途 OpenAPI 的多时间框架技术分析 skill，支持美股 / A股 / 港股实时扫描与选股。

> **33/33 单元测试全部通过（热点股测试需Futu实时数据）** | GitHub: [SailorChina/stock-signals](https://github.com/SailorChina/stock-signals)
