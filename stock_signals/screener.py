...
_US_HOT_STOCKS_POOL = [
    ...
    'US.APH', 'US.TEL', 'US.GLW', 'US.KEYS', 'US.ZBRA', 'US.JNPR', 'US.NTAP', 'US.STX', 'US.WDC', 'US.FDX',    'US.FISV', 'US.GPN', 'US.TSCO', 'US.ROST', 'US.BBY', 'US.AAP', 'US.TWLO', 'US.SAM', 'US.WBA', 'US.AMN',    'US.BIO', 'US.KRA', 'US.OLF', 'US.AFL', 'US.HIG', 'US.CINF', 'US.L', 'US.RHI', 'US.J', 'US.HII',    'US.KTOS', 'US.EW', 'US.DGX', 'US.QHR', 'US.LH', 'US.TH', 'US.CAG', 'US.SJM', 'US.COH', 'US.UAA',    'US.VFC', 'US.CLF', 'US.CE', 'US.X', 'US.RS', 'US.PKG', 'US.IP', 'US.CC', 'US.FMC', 'US.SHW',    'US.CVV', 'US.DVN', 'US.FANG', 'US.HES', 'US.MRO', 'US.CNQ', 'US.SU', 'US.WES', 'US.TRGP', 'US.CMCSA',    'US.OMC', 'US.IPG', 'US.NWSA', 'US.FOXA', 'US.PARA', 'US.WBD', 'US.AMT', 'US. ESS', 'US.EXR', 'US.AVB',    'US.EQR', 'US.SBAC', 'US.CCI', 'US.PLD', 'US.CUZ', 'US.DEI', 'US.SUI', 'US.HIW', 'US.WPC', 'US.PINE',    'US.ALEX', 'US.MHO', 'US.IIPR', 'US.VNO', 'US.KRC', 'US.NNN', 'US.OHI', 'US.PGRE', 'US.APN', 'US.BIV',    'US.BRC', 'US.BTZ', 'US.BXI', 'US.CDL', 'US.CDRL', 'US.CDTI', 'US.CDX', 'US.CEH', 'US.CFG', 'US.CFNB',    'US.CFGS', 'US.CG', 'US.CHA',]
